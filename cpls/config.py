...
ALCHEMY_API_KEY_SYNDICATE_L3_STAKING_NON_AGORA_ACCOUNT = os.getenv("ALCHEMY_API_KEY_SYNDICATE_L3_STAKING_NON_AGORA_ACCOUNT", '')
...
print(f"ALCHEMY_API_KEY_SYNDICATE_L3_STAKING_NON_AGORA_ACCOUNT: {ALCHEMY_API_KEY_SYNDICATE_L3_STAKING_NON_AGORA_ACCOUNT}")
